...
class Lady_CreateViewController: UIViewController, UITextViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func lady_createAI(_ sender: UIButton) {
        ...
        let dict = ["lady_name":lady_name_filed.text!, "lady_desc":lady_preface_textView.text!, "lady_material":lady_matery_textView.text!, "lady_image": "lady_11549"]
        self.lady_lists.append(dict)
        UserDefaults.standard.setValue(lady_lists, forKey: "create")
